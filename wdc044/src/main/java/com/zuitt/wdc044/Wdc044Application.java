...
// This indicates that the class is a controller that will handle RESTful web requests and returns an HTTP response.
@RestController
...
//	@RequestParam is used to extract query parameters, form parameters followed by "key=value" pair.
	...
	//	S01 Activity Stretch Goal
	// localhost:8080/nameAge
	// localhost:8080/nameAge?name=John&age=18
	@GetMapping("/nameAge")
